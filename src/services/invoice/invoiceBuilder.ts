...
export function buildInvoice(
  ...
  return {
    ...
    buyerAddressLine: options.buyerAddressLine.trim(),
    buyerCity: options.buyerCity.trim(),
    buyerPincode: options.buyerPincode.trim(),
    buyerState: options.buyerState.trim(),
    buyerStateCode: options.buyerStateCode.trim(),
    billingFrom,
    billingTo,
    invoiceDate,
